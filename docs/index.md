...
features:
  - title: Queue staffing
    details: >-
      Size your team with Erlang C, or model customer abandonment with the
      Erlang A (M/M/c+M) queue. Sweep many scenarios at once with MultiErlangC.
    link: /guide/erlangc
  ...
  - title: Rostering
    details: >-
      ...
      shifts, minimum hours and individual preferences.
